...
public class Transaction {
	...
	// CENG435
	private static int isolationLevel = Connection.TRANSACTION_READ_UNCOMMITTED;
	...
	public int getInt(Block blk, int offset) {
		...
		case 8:
			Block dummyblk = new Block(blk.fileName(), END_OF_FILE);
		...
		case 1:
			...
			return buff.getInt(offset);
		default:
			throw new UnknownIsolationLevelException();
		}
	}
